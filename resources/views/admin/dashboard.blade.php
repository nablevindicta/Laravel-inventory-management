...
@section('content')
    <x-container>
        ...
        <div class="col-sm-6 col-xl-3">
            <x-widget title="Barang Masuk" :subTitle="$inboundGoodsCount" class="bg-green">
        ...
        <div class="col-sm-6 col-xl-3">
            <x-widget title="Barang Keluar" :subTitle="$outboundGoodsCount" class="bg-cyan">
        ...
        <div class="col-sm-6 col-xl-3">
            <x-widget title="Barang Keluar Bulan ini" :subTitle="$outboundThisMonthCount" class="bg-teal">
